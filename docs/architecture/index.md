...
| Isolation        | `microvm.nix` gateways + QEMU/KVM Windows 11 VM (`nixos/windows-vm.nix`) | [Networking](../networking/index.md) · [Virtualization](../system/virtualization.md) |
| Phone            | Nix-on-Droid target + phone-agent MCP bridge | [Phone](../phone/index.md)             |
