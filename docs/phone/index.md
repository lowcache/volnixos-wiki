...
| :--- | :--- | :--- | :--- |
| [Nix-on-Droid](nix-on-droid.md) | A real Nix store and Home Manager profile running on the phone | `com.termux.nix` | [`droid/`](https://github.com/lowcache/volnixos/blob/main/droid/) |
| [Phone Agent](phone-agent.md) | An MCP server on the phone that the **laptop** calls over Tailscale | `com.termux` | [`nixos/phone-agent/`](https://github.com/lowcache/volnixos/blob/main/nixos/phone-agent/) |
| [Android VM](../system/virtualization.md#android-vm-dormant) | A libvirt guest on the laptop — no physical phone involved | — | [`nixos/android-vm.nix`](https://github.com/lowcache/volnixos/blob/main/nixos/android-vm.nix) |
...
[Nix-on-Droid: the phone as a Nix host](nix-on-droid.md){ .md-button .md-button--primary }
[Phone Agent: the laptop's remote sensors](phone-agent.md){ .md-button }
