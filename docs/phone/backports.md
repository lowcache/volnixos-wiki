...
(glibc 2.40) package set. It exists because the [glibc pin](nix-on-droid.md#why-the-package-set-is-pinned)
...
[Nix-on-Droid](nix-on-droid.md#agent-layer-droidagentsnix). Backporting is deliberately kept to the
two packages that carry their weight.
